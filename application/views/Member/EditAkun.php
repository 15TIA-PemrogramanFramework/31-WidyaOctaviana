	...
	?>
		                        <div class="tab-content">
		                            <div class="tab-pane" id="about">
		                            	<div class="row">
											<h5 class="info-text"> Ubah Pengaturan Akun Anda.</h5>
										
											
											<div class="col-sm-10 col-sm-offset-1">
											
					<input type="hidden" name="username"  value="<?php echo $this->session->userdata('member')->username ?>" >
					<input type="hidden" name="passworddulu" value="<?php echo $this->session->userdata('member')->password ?>">
					<input type="hidden" name="emaildulu" value="<?php echo $this->session->userdata('member')->email ?>">
												...
												<div class="form-group">
													<label>Confirmasi Password baru <small>(required)</small></label>
													<input name="repassword" type="password" class="form-control" >
													<div class="tulisan"><?php echo form_error('repassword'); ?></div>
												</div>
												<div class="form-group">
													<label> Password sebelumnya<small>(required)</small></label>
													<input name="passwordlama" type="password" class="form-control" >
													<div class="tulisan"><?php echo $katakata; ?></div>
												</div>
											</div>
										</div>
		                            </div>
