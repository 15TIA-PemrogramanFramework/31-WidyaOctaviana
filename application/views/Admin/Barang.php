...
$data['alamat']="
<li class='active'><a href='".site_url('Dashboard/Barang')."'>Barang</a></li>";
...
<div class="row">
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue">Daftar Barang</h3>
				...
				<tbody>
					...
					<?php foreach ($semuabarang as $key => $value) {
						...
						<tr>
							...
							<td><a href="<?php echo site_url('Dashboard/DetailBarang/'.$value->id_barang) ?>">Detail</a></td>
