...
$data['alamat']="
<li class='active'><a href='".site_url('Dashboard/Komentar')."'>Komentar</a></li>";
$data['alamatactive']="komentar";
	...
	<div class="col-xs-12">
		...
		<div>
			<table id="dynamic-table" class="table table-striped">
				...
				<tbody>
					<?php foreach ($semuakomentar as $key => $value) {?>
					<tr>
						<td class="center">
							<label class="pos-rel">
								<input type="checkbox" class="ace" />
						...
						<td>
							<div class="hidden-sm hidden-xs action-buttons">
								...
								<a class="red" href="<?php echo site_url('Dashboard/DeleteKomentar/'.$value->id_komentar) ?>">
