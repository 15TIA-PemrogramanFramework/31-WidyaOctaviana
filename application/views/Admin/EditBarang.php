	...
	<div id="user-profile-3" class="user-profile row">
		<div class="col-sm-offset-1 col-sm-10">
			...
			<img id="avatar" style="display:none" class="editable img-responsive" alt="Foto" 
 			...
 			src="<?php echo base_url().'assets/image/'.$barang->gambar_barang?>" />

			<div class="space"></div>


			<form class="form-horizontal" action="<?php echo site_url('Dashboard/EditBarang_aksi') ?>"  method="post" enctype="multipart/form-data" >
<input type="hidden" name="id_barang" value="<?php echo $barang->id_barang ?>">
				<div class="tabbable">
				<div class="tab-content profile-edit-tab-content">
						<div>
<input type="hidden" name="gambardulu" value="<?php echo $barang->gambar_barang ?>">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-8">
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											type="text" id="form-field-username" placeholder="nama barang" value="<?php echo $barang->nama_barang ?>"
											/>
										</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-8">
											...
											type="text" id="form-field-username" placeholder="harga barang" value="<?php echo $barang->harga_barang ?>"
											/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<span class="input-icon input-icon-right">
												<input type="number" name="stok_barang" value="<?php echo $barang->stok_barang ?>"  placeholder="stok barang" />
...
<label class="col-sm-3 control-label no-padding-right" for="form-field-comment">Deskripsi barang</label>
																...
																<div class="col-sm-9">
<textarea  name="detail_barang"  id="form-field-comment" cols="50" rows="5"><?php echo $barang->detail_barang ?></textarea>
																</div>
															</div>
