...
<td> <a href="<?php echo site_url('Dashboard/DetailTransaksi/'.$transaksi->id_transaksi) ?>">Detail</a></td>
<td><?php if ($transaksi->bukti_transaksi!="belum"): ?>
	<a href="<?php echo site_url('Dashboard/downloadBuktiTransaksi/'.$transaksi->id_transaksi) ?>">Download</a> 
<?php endif ?></td>
									</tr>
...
<?php if($transaksi->validasi_bukti=!"valid") {?>
...
<div class="col-xs-12 col-sm-3">
														<div class="space visible-xs"></div>
														<h4 class="header blue lighter less-margin">Bukti Valid</h4>
...
<script type="text/javascript">
	...
	jQuery(function($) {
				...
				//select/deselect all rows according to table header checkbox
				$('#simple-table > thead > tr > th input[type=checkbox], #simple-table_wrapper input[type=checkbox]').eq(0).on('click', function(){
					var th_checked = this.checked;//checkbox inside "TH" table header
				...
				$(document).on('click', '#simple-table .dropdown-toggle', function(e) {
