...
<li class='active'><a href='".site_url('Dashboard/Admin')."'>Admin</a></li>";
...
<div class="row">
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue">Daftar Admin</h3>
		...
		<div class="clearfix">
			...
			<div class="pull-right tableTools-container">
				<?php if ($this->session->userdata('admin')->status=="pemilik"): ?>
					<a href="<?php echo site_url('Dashboard/TambahAdmin') ?>">
		...
		<div class="table-header">
			Karyawan dan Admin Kangen Water
		</div>
		...
		<div>
			<table id="dynamic-table" class="table table-striped">
				...
				<tbody>
					...
					<?php foreach ($semuakaryawan as $key => $value) {
						
						?>
						<tr>

							<td>
								<a href="<?php echo site_url('Dashboard/ProfilAdmin/'.$value->username) ?>">
									<?php echo $value->username; ?>
								</a>
							</td>
							<td><?php echo $value->nama; ?></td>
							<td><?php echo $value->tanggal_lahir; ?></td>
							<td><?php echo $value->waktu_regis; ?></td>
